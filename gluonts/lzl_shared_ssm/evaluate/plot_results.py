...
plot_result_root = 'evaluate/results'


common_lstm_result_path = os.path.join(plot_result_root,'common_lstm(btc,eth)_freq(1D)_past(90)_pred(5)_LSTM(2-40)_use_time(False)_loss_origin(True)_epoch(60)_bs(32)_bn(13)_lr(0.001)_dropout(0.1).pkl')
common_lstm_with_time_result_path = os.path.join(plot_result_root,'common_lstm(btc,eth)_freq(1D)_past(90)_pred(5)_LSTM(2-40)_use_time(True)_loss_origin(True)_epoch(60)_bs(32)_bn(13)_lr(0.001)_dropout(0.1).pkl')
shared_ssm_result_path = os.path.join(plot_result_root,'shared_ssm(btc,eth)_freq(1D)_lags(0)_past(90)_pred(5)_u(5)_l(4)_K(2)_T(2-40)_E(2-50)_α(50)_epoch(50)_bs(32)_bn(13)_lr(0.001)_initKF(0.05)_initCov(10.0)_dropout(0.5).pkl')
shared_ssm_without_env_result_path = os.path.join(plot_result_root , 'shared_ssm_without_env(btc,eth)_freq(1D)_lags(0)_past(90)_pred(5)_u(5)_l(4)_K(2)_T(2-40)_E(2-50)_α(50)_epoch(50)_bs(32)_bn(13)_lr(0.001)_initKF(0.05)_initCov(10.0)_dropout(0.5).pkl')
prophet_result_path = os.path.join(plot_result_root , 'prophet(btc,eth)_freq(1D)_lags(0)_past(90)_pred(5).pkl')
deep_state_result_path = os.path.join(plot_result_root , 'deepstate(btc,eth)_freq(1D)_past(90)_pred(5)_LSTM(2-40)_trend(False)_epoch(50)_bs(32)_bn(13)_lr(0.001)_dropout(0.1).pkl')
ground_truth_path = os.path.join(plot_result_root,'ground_truth(btc,eth)_freq(1D)_lags(0)_past(90)_pred(5)_u(5)_l(4)_K(2)_T(2-40)_E(2-50)_α(50)_epoch(50)_bs(32)_bn(13)_lr(0.001)_initKF(0.05)_initCov(10.0)_dropout(0.5).pkl')
...
if __name__ == "__main__":
    ...
    for ssm_no in np.arange(0,ground_truth_target.shape[0]):
        ...
        for sample in np.arange(ground_truth_target.shape[1]):
            ...
            ax.plot(pred_time_range , s3, linestyle='-.' , color = 'tab:cyan', marker='o' , label='shared_ssm(without_time)')
