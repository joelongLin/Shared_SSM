...
import time
import datetime
from gluonts.lzl_shared_ssm.models.LSTNet_compared.utils import *
from gluonts.lzl_shared_ssm.models.LSTNet_compared.LSTNet import LSTNet ,LSTNet_multi_inputs
import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--multi', type=int, default=0, help='original(0) or multi-input(1) LSTNet_compared')
