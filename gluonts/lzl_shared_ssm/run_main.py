...
cl.DEFINE_integer('batch_size' ,  1 , 'Numbere of examples in each batch')
...
cl.DEFINE_bool('use_env' , False , 'whether use environment variable to generate control seq' )
...
cl.DEFINE_string('slice' , '' , 'how to slice the dataset')
cl.DEFINE_string('freq','1D','Frequency of the data to train on and predict')
cl.DEFINE_integer('past_length' ,498,'This is the length of the training time series')
